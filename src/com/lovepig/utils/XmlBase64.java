...
//		}    	    	
    	...
    	LogInfo.LogOut("sEncode:" + sEncode);
    	byte[] str = decode(sEncode);
    	
    	LogInfo.LogOut("decode:" + new String(str));
    	...
    	*/
        ...
        LogInfo.LogOut("b:" + new String(b));
		/*String queryKeyword = new String(b);
		String sName = new String(b,"utf-8");
		
		LogInfo.LogOut(queryKeyword);
		LogInfo.LogOut(sName);
		LogInfo.LogOut("over");*/
//		byte[] b3 = decode("54yu5LiWTGl2ZSjlkajmnbDkvKYp");	
        byte[] b3 = decode("54ix");
		                    
		LogInfo.LogOut(new String(b3,"utf-8"));
		LogInfo.LogOut(new String(b3));
    }
}
