...
public class Configs {
	...
	// public static String WEIBO_SECRET_KEY =
	// "30b3ce0941a6a5634dc26810956a71c2";
	/**
	 * 是否开启程序日志
	 */
	...
	public static void initTypeAndVsersion(Activity context) {
		try {
			...
			stringer.key("resolution").value(
					Utils.getScreenWidth(context) + "X"
			...
			stringer.key("imsi").value(
					Utils.getIMSI(context) == null ? "" : Utils
							.getIMSI(context));
	...
	public static void updateUidToTypeAndVsersion(String uid, String username,
			int memberId) {
	...
	public static void setSpecial(Context c, boolean isSpecial) {
		c.getSharedPreferences(PREFS_NAME, 0).edit()
				.putBoolean("isSpecial", isSpecial).commit();
	}
	...
	public static boolean isSpecial(Context c) {
		return c.getSharedPreferences(PREFS_NAME, 0).getBoolean("isSpecial",
				false);
	}
	...
	public static void setTxtGravity(Context c, int gravity) {
		c.getSharedPreferences(PREFS_NAME, 0).edit().putInt("gravity", gravity)
				.commit();
	}
	...
	public static void setTxtSize(Context c, int size) {
		c.getSharedPreferences(PREFS_NAME, 0).edit().putInt("txtsize", size)
				.commit();
	}
	...
	public static void setTipSize(Context c, int size) {
		c.getSharedPreferences(PREFS_NAME, 0).edit().putInt("tipSize", size)
				.commit();
	}
	...
	public static int getBookShelfCurrentType(Context c) {
		return c.getSharedPreferences(PREFS_NAME, 0).getInt(
				"shelf_current_type", 0);
	}

	public static void setBookShelfCurrentType(Context c, int type) {
		c.getSharedPreferences(PREFS_NAME, 0).edit()
				.putInt("shelf_current_type", type).commit();
	}
	...
	public static void setIMEI(Context c, String imei) {
		c.getSharedPreferences(PREFS_NAME, 0).edit().putString("IMEI", imei)
				.commit();
	}
	...
	public static boolean isShowNewHelp(Context c) {
		return c.getSharedPreferences(PREFS_NAME, 0).getBoolean(
				"isShowNewHelp", true);
	}

	public static void setShowNewHelp(Context c, boolean isShowNewHelp) {
		c.getSharedPreferences(PREFS_NAME, 0).edit()
				.putBoolean("isShowNewHelp", isShowNewHelp).commit();
	}
	...
	public static void setShowMoreHelp(Context c, boolean isShowNewHelp) {
		c.getSharedPreferences(PREFS_NAME, 0).edit()
				.putBoolean("isShowMoreHelp", isShowNewHelp).commit();
	}
	...
	public static boolean isShowShoppingHelp(Context c) {
		return c.getSharedPreferences(PREFS_NAME, 0).getBoolean(
				"isShowShoppingHelp", true);
	}

	public static void setShowShoppingHelp(Context c, boolean isShowNewHelp) {
		c.getSharedPreferences(PREFS_NAME, 0).edit()
				.putBoolean("isShowShoppingHelp", isShowNewHelp).commit();
	}
	...
	public static void setShowBookHelp(Context c, boolean isShowNewHelp) {
		c.getSharedPreferences(PREFS_NAME, 0).edit()
				.putBoolean("isShowBookHelp", isShowNewHelp).commit();
	}
