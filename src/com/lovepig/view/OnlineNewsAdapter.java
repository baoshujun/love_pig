...
public class OnlineNewsAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            if (position == 0) {
                view = new OnlineNewsFirstView(manager.context, R.layout.online_news_item_first, manager);
            } else {
...
//                syncImageLoader.imageLoader(viewHolder.img, news.picurl, R.drawable.news_detail_head, position);
                ...
                if (URLUtil.isHttpUrl(news.iconPath)) {
                    syncImageLoader.imageLoaderScale(viewHolder.img, news.iconPath+"_160x85.jpg", R.drawable.ic_launcher, position);
                } else {
