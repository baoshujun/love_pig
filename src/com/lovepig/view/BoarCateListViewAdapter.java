...
public class BoarCateListViewAdapter extends BaseAdapter {
	private ArrayList<BoarCateModel> list;
	private Context context;
	private LayoutInflater inflater = null;
	private static int currentPostion = -1;

	public BoarCateListViewAdapter(ArrayList<BoarCateModel> list,
			Context context) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.cateName.setText(list.get(position).categorization);
		// holder.cateImg.s
